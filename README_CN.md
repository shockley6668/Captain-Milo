...
**Captain Milo** 是由国泰航空黑客松 **E094 团队** 开发的智能泰迪熊陪伴系统，专为无陪伴未成年乘客设计。该系统基于 ESP32 和 RDK 平台，集成了 ASR（自动语音识别）、LLM（大语言模型）、TTS（文本转语音）、IOT 和 Web 技术，通过离线和在线语音交互为独自乘机的未成年旅客提供陪伴、指导和安全保护。并且搭配 Web 显示界面，实现便捷的UM儿童管理和家长交互体验。
